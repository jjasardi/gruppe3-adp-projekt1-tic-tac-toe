/**
 * In der Klasse Spiellogik wird geprueft ob Operationen regelkonform sind. Hier
 * wird der Spielerzug gewechselt und entschieden ob das Spiel zu Ende ist.
 * 
...
public class Spiellogik {
     ...
     * 
     * @param spielFeld ist der Parameter der dem Objekt SpielFeld in TicTacToeGame
     *                  zugewiesen ist.
     * @param sprache   ist der Parameter der dem Objekt sprache in TicTacToeGame
     *                  zugewiesen ist.
     */
    ...
    /**
     * Diese Methode wechselt zwischen Spieler 1 und 2 und gibt eine entsprechende
     * Aussage.
     */
     ...
     * Anschliessend veraendert sie den Wert eines Feldes und stellt das Spiel dar.
     * Daraufhin prueft die Methode ob das Spiel zu ende ist und macht entsprechende
     * Aussagen.
     * 
     * @param feldId ist ein String der einem Feld mittels getFeld() aus der Klasse
     *               Spielfeld zugewiesen wird.
     */
