/**
 * In der Klasse Spielfeld werden die Werte fuer die Felder veraendert. Hier
 * wird geprueft wer gewonnen hat. Hier ist die Methode um das Spielfeld
 * darzustellen. Das Spielfeld sieht folgendermassen aus: 
...
public class Spielfeld {
    ...
    /**
     * Konstruktor erstellt 9 neue Objekte fuer das Spielfeld und ein extra Feld
     ...
     * 
     * @param feldId ist ein String der einem Feld mittels getFeld() zugewiesen
     *               wird.
     */
    ...
    /**
     * Die Methode istFeldValide prueft ob der eingegebe String in getFeld()
     * vorgesehen ist.
     * 
     * @param feldId ist ein String der einem Feld mittels getFeld() zugewiesen
     *               wird.
    ...
    /**
     * Die Methode feldEingeben aendert den Wert eines Feldes zu 1 fuer Spieler 1,
     * oder zu 2 fuer Spieler 2.
     * 
     * @param feldId           ist ein String der einem Feld mittels getFeld()
     *                         zugewiesen wird.
    ...
    public boolean spielUnentschieden() {
        if (x1.getZustand() != 0 && x2.getZustand() != 0 && x3.getZustand() != 0 && z1.getZustand() != 0
                && z2.getZustand() != 0 && z3.getZustand() != 0 && y1.getZustand() != 0 && y2.getZustand() != 0
                && y3.getZustand() != 0) {
            return true;
        } else
            return false;
